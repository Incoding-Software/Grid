...
namespace Grid.Interfaces
{
    public interface IGridBuilderOptions<T> where T : class
    {
        ...
        IGridBuilderOptions<T> RowHtmlClass(B htmlClass);
        IGridBuilderOptions<T> RowHtmlClass(string htmlClass);
        ...
        IGridBuilderOptions<T> HeadHtmlClass(B htmlClass);
        IGridBuilderOptions<T> HeadHtmlClass(string htmlClass);
        ...
        IGridBuilderOptions<T> NextRowHtmlClass(B htmlClass);
        IGridBuilderOptions<T> NextRowHtmlClass(string htmlClass);
